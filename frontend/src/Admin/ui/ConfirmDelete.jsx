...
export default function ConfirmDelete({ handelClick, close }) {
  return (
              ...
              <div className="w-full border-2 border-gray-900 rounded-lg p-8 bg-stone-100 font-bold">
                ...
                <div className="flex items-center justify-center p-5 pt-8">
                  <div className="w-1/2">
                    <div
                      onClick={() => close(false)}
                      className="bg-stone-400 border border-gray-600 font-semibold rounded-md p-2 px-4 mx-2"
                    >
                      Cancel
                    </div>
                  </div>
                  <div className="w-1/2">
                    <div
                      className="bg-red-400 border border-gray-600 font-semibold rounded-md p-2 px-4 mx-2"
                      onClick={handelClick}
                    >
                      Delete
                    </div>
