...
//                     {(readmore) ? (course.courseDescription) : (`${course.courseDescription.substring(0, 50)}`)}
//                     <span className="read-more cursor-pointer font-semibold " onClick={()=>setReadmore(!readmore)}>
